  ...
  <div>
    ...
    <div class="table">
      <el-table :data="tableData" stripe  @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="doctorName" label="醫生姓名" show-overflow-tooltip></el-table-column>
        <el-table-column prop="departmentName" label="科室" show-overflow-tooltip></el-table-column>
        <el-table-column prop="num" label="就診數量"></el-table-column>
        <el-table-column prop="week" label="工作時間"></el-table-column>
    ...
    <el-dialog title="信息" :visible.sync="fromVisible" width="40%" :close-on-click-modal="false" destroy-on-close>
      <el-form label-width="100px" style="padding-right: 50px" :model="form" :rules="rules" ref="formRef">
        <el-form-item prop="doctorId" label="選擇醫生">
          <el-select v-model="form.doctorId" placeholder="選擇醫生" style="width: 100%">
            <el-option
